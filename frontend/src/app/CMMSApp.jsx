...
export default function CMMSApp({ initialPage = "" }) {
  ...
  const [active, setActiveState] = useState(() => {
    ...
    return ["dashboard", "customers", "equipment", "engineers", "work-orders", "pm-plans", "schedule", "failures", "inventory", "reports", "kpis", "settings", "access-control"].includes(page) ? page : "dashboard";
  });
