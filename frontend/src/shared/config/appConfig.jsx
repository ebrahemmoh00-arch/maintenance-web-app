...
export function isVisiblePageForUser(user, page) {
  ...
  if (page === "failures") return hasPermission(user, "work-orders", "view") || hasPermission(user, "equipment", "view");
...
export const AR = {
  ...
  "Asset Health Ranking": "ترتيب صحة المعدات",
  "Assets ordered by calculated health score. Lower score means faster reliability attention.": "المعدات مرتبة حسب نسبة الصحة المحسوبة. النسبة الأقل تعني احتياج أسرع لمراجعة الاعتمادية.",
  "Health %": "نسبة الصحة",
  "No asset health data available yet.": "لا توجد بيانات صحة معدات حتى الآن.",
  "Unassigned site": "موقع غير محدد",
